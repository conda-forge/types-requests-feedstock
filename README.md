...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-requests-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-requests-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-requests
# for installing globally
pixi global install types-requests
```
...
It is possible to list all of the versions of `types-requests` available on your platform:
...
```
pixi search types-requests --channel conda-forge
```
